...
import static be.snife.sbms.productcomposite.IsSameEvent.sameEventExceptCreatedAt;
...
import be.snife.sbms.api.composite.product.RecommendationSummary;
import be.snife.sbms.api.composite.product.ReviewSummary;
...
class MessagingTests {
	...
	void createCompositeProduct1() {
		...
		Event<Integer, Product> expectedEvent = new Event<Integer, Product>(Event.Type.CREATE, composite.getProductId(),
	...
	void createCompositeProduct2() {
		...
		Event<Integer, Product> expectedProductEvent = new Event<Integer, Product>(Event.Type.CREATE, composite.getProductId(),
				new Product(composite.getProductId(), composite.getName(), composite.getWeight(), null));
		...
		Event<Integer, Recommendation> expectedRecommendationEvent = new Event<Integer, Recommendation>(Event.Type.CREATE, composite.getProductId(),
		...
		Event<Integer, Review> expectedReviewEvent = new Event<Integer, Review>(Event.Type.CREATE, composite.getProductId(),
